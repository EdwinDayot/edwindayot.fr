...
test("D.quests carries the two free-garden starter entries plus C3.6's campaign tool quest, C4.2's house-unlock quest and C4.5's second tool quest, not the full 6-10 quest ladder (Épic 2.2, separate task)", () => {
